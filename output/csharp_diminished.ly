...
\header{
  title = \markup { "C" \sharp " Diminished Scale" }
  subtitle = \markup { "Etude" }
  tagline = ##f
}

\tocItem \markup { "C" \sharp " Diminished Scale" }
...
\score {
  ...
  \header{
    piece = \markup { "C" \sharp " Diminished Scale" }
  }
}
...
\score {
  ...
  \header{
    piece = \markup { "C" \sharp " Diminished Scale Harmonization" }
  }
}
